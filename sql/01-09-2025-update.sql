...
COPY public."Customer" (customer_id, customer_fname, customer_lname, customer_phone_num, customer_address, customer_gender, customer_username, customer_password, customer_address_long, customer_address_lat) FROM stdin;
1	Kurt Ivanne	Galler	9474691163	Poblacion Sur Carmen, Bohol	Male	kurtivan23	$2a$10$ZZuwHBJwZD9vLmn1h4lPOuOjN3PIypk12PzvrMWT/E85yBMvQEu5C	9.832585	124.188775
9	John	Doe	1234567890	123 Main St	Male	johndoe	$2a$10$xKRJY1EdJ5/rwzHqQExTde41qafoQsZMhbRVPjPMcXg9GpI5frhd6	40.7128	-74.006
\.
...
COPY public.app_owner (app_owner_id, app_owner_fname, app_owner_lname, app_owner_phone_num, app_owner_address, app_owner_gender, app_owner_username, app_owner_password) FROM stdin;
\.
...
COPY public.authentication (userid, token, created_at) FROM stdin;
4	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NCwidHlwZSI6MiwiaWF0IjoxNzM2NDIyMjY5LCJleHAiOjE3MzY0MjU4Njl9.81eGw7t-vMRcayGi42ZSAYdwnn87JsSWzJA5Y2fyT_c	2025-01-09 19:31:09.960256+08
6	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NiwidHlwZSI6MywiaWF0IjoxNzM2NDIyNjI3LCJleHAiOjE3MzY0MjYyMjd9.2rF14L--gECTDQmQaSW85wspIfW4uYWhKC3JqNxOAOk	2025-01-09 19:37:07.176046+08
9	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6OSwidHlwZSI6MSwiaWF0IjoxNzM2NDIyOTI5LCJleHAiOjE3MzY0MjY1Mjl9.f1s5wG1J6puMN0DIKLb7WcZsuMyKSUM8mefYaYpaN0M	2025-01-09 19:42:09.77531+08
\.
...
COPY public.feedback (feedback_id, feedback_rating, feedback_description, order_id) FROM stdin;
\.
...
COPY public.inventory (inv_id, staff_id) FROM stdin;
\.
...
COPY public."order" (order_id, order_status, order_service_type, order_type, order_schedule, order_location, customer_id, order_longitude, order_latitude, order_created) FROM stdin;
\.


--
-- Data for Name: order_delivery_sales; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.order_delivery_sales (ods_id, ods_payment_method, ods_payment_confirm_photo, ods_delivery_confirm_photo, ods_time_complete, order_id, staff_id) FROM stdin;
\.


--
-- Data for Name: order_pick_up_sales; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.order_pick_up_sales (ops_id, ops_payment_method, ops_payment_confirm_photo, ops_time_complete, order_id, staff_id) FROM stdin;
\.
...
COPY public.order_product (order_product_id, order_product_quantity, order_product_price, order_id, stock_id) FROM stdin;
\.
...
COPY public.product (product_id, product_water_type, product_price, product_size, station_id) FROM stdin;
\.
...
COPY public.product_inventory (prod_inv_id, prod_inv_type, prod_inv_quantity, prod_inv_time_date, staff_id, product_id) FROM stdin;
\.
...
COPY public.staff (staff_id, staff_fname, staff_lname, staff_type, staff_phone_num, staff_gender, staff_username, staff_password, station_id) FROM stdin;
2	John	Doe	Delivery	1234567890 	Male	johndoe	$2a$10$yXnQY6dwsui0EEZUv74nceSGQc3aIwXQlKNUHJzzzFPjHcT/ZkqBy	\N
6	Johns	Does	Onsite	1234567891 	Male	johndoes	$2a$10$qrBTNPClroV7gMgfG9RGeOBVGCz4BK7wnqeWJQ/Zya35kLi1bCv9q	\N
\.
...
COPY public.station_owner (st_owner_id, st_owner_fname, st_owner_lname, st_owner_phone_num, st_owner_gender, st_owner_username, st_owner_password) FROM stdin;
4	John	Doe	1234567890 	Male	johndoe	$2a$10$qt.7AgtLWEqd6rhiGwtIGOkNP8ZuYN.yDfrMdDfPcbSbNUN8eIDpy
\.


--
-- Data for Name: walk_in_product; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.walk_in_product (walk_in_product_id, walk_in_quantity, walk_in_price, walk_in_id, product_id) FROM stdin;
\.


--
-- Data for Name: walk_in_sales; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.walk_in_sales (walk_in_id, walk_in_trans_type, walk_in_payment_method, walk_in_payment_confirm_photo, walk_in_payment, staff_id) FROM stdin;
\.


--
-- Data for Name: water_refilling_station; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.water_refilling_station (station_id, station_name, station_address, station_phone_num, station_longitude, station_latitude, station_paymaya_acc, station_gcash_qr, station_paymaya_qr) FROM stdin;
\.
